...
(async () => {
  ...
  for(var x = 0;x < 1000;x++){
    ...
    await page.goto("https://directory.mercer.edu/");
    await page.click("input#MainContent_rdoSearchGroup_0");
    await page.click("input#MainContent_chkIncSimilar")
    // Type in name and click
    await page.click("input#txtSearch.txtSearch")
  ...
  for (var i = 0; i<data.length; i++){
    if(data[i].includes("@live.mercer.edu")){
    ...
    fs.writeFile("Mercer_2020_November.txt", emails, function(error){
